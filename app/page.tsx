...
const games: Game[] = [
  ...
  sheetGame("덱커스", "보드피아", "사이버펑크 테마의 1인용 덱빌딩 게임입니다.", "콘 신작", "전략", "적당히"),
