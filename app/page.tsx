...
const games: Game[] = [
  ...
  sheetGame("킹덤 크로싱", "아스모디", "쾨니히스베르크의 다리 문제를 풀어낸 전략 게임입니다.", "콘 신작", "전략", "적당히"),
  sheetGame("내셔널 이코노미", "아스모디", "수요와 공급을 일꾼 놓기 방식으로 풀어낸 게임입니다.", "콘 신작", "전략", "적당히"),
  sheetGame("패스 더 워드", "아스모디", "《텔레스트레이션》과 《저스트 원》의 감각을 결합한 파티게임입니다.", "콘 신작", "파티"),
  sheetGame("코스모", "아스모디", "서로 다른 덱을 골라 즐기는 홀덤 게임으로, 비딩으로 운을 극복할 수 있습니다.", "콘 신작", "파티", "적당히"),
  sheetGame("타카마치", "아스모디", "주사위로 패턴을 찾는 보드게임입니다.", "콘 신작", "가족"),
  sheetGame("언매치드: 닌자 거북이", "아스모디", "《언매치드》에 닌자 거북이 IP를 더한 확장입니다.", "콘 신작", "2인", "적당히"),
  sheetGame("암바르", "아스모디", "푸시 유어 럭과 추상전략을 결합한 게임입니다.", "콘 신작", "전략"),
  sheetGame("캐치 스케치: 롤&메스", "아스모디", "주사위로 그림 그리기 규칙을 더하는 확장입니다.", "콘 신작", "파티"),
