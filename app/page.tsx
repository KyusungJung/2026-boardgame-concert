...
const games: Game[] = [
  ...
  { title: "카르디아", publisher: "만두게임즈", type: "2인", weight: "적당히", players: "2인", time: "20분", status: "대표작", description: "동시 공개한 카드의 높낮이에 따라 인장 획득과 카드 능력이 갈리는 심리전입니다.", audience: "블러핑과 심리전을 좋아하는 2인", video: "카르디아 보드게임" },
  ...
  { title: "세티: 우주 기관", publisher: "보드피아", type: "전략", weight: "깊게", players: "1–4인", time: "90–150분", status: "콘 신작", description: "비대칭 우주기관 11개와 외계종족 3종, 새 프로젝트를 더하는 《세티》 확장입니다.", audience: "세티를 깊게 즐긴 전략 게이머", video: "세티 우주 기관 보드게임" },
  ...
  { title: "플라워즈", publisher: "보드엠", type: "가족", weight: "가볍게", players: "2–4인", time: "20분", status: "콘 신작", description: "숫자 카드의 등장 빈도와 배치 조건으로 꽃밭을 완성하는 카드 퍼즐입니다.", audience: "예쁜 테이블 게임을 원하는 가족", video: "플라워즈 보드게임" },
  ...
  { title: "테이크 타임", publisher: "보드엠", type: "협력", weight: "적당히", players: "2–4인", time: "20분", status: "콘 신작", description: "제한된 의사소통만으로 숫자 카드를 시계 둘레에 배치하는 협력 퍼즐입니다.", audience: "말 없이 호흡을 맞추는 협력을 좋아하는 팀", video: "테이크 타임 보드게임" },
